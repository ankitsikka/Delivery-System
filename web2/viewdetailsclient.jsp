     ...
     <%
         String url="jdbc:mysql://localhost/crimefiledb";                  
              ...
              try
              {
                  ...
                  try
                  {    
                      String q="select * from complaintform where firno=? AND username=?";
                      ...
                      if(myresult22.next()){out.println("Status : "+myresult22.getString("status")+"<br><br/>");}
                       ...
                       String q1="select * from lostfound where firno=? AND username=?";
                      PreparedStatement mystatement1=myconnection.prepareStatement(q1);
                       mystatement1.setString(1, fir);
                        mystatement1.setString(2, String.valueOf(session.getAttribute("cuname")));
