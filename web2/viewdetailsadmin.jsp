     ...
     <%
         String url="jdbc:mysql://localhost/crimefiledb";                  
              ...
              try
              {
                  ...
                  try
                  {    
                      String q="select * from complaintform where firno=? ";
                      ...
                      if(myresult.next())
                      {
                           out.println("Status : "+myresult.getString("status")+"<br><br/>");
